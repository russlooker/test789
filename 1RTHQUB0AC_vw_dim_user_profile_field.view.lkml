...
view: 1RTHQUB0AC_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1RTHQUB0AC] ;;
...
dimension: profile_adp_file_number {
    sql: ${TABLE}.profile_ADPFileNumber ;;
    type: string
}


    
dimension: profile_payrollnumber {
    sql: ${TABLE}.profile_payrollnumber ;;
    type: string
}
