...
view: 1PDBRLEB2Q_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1PDBRLEB2Q] ;;
...
dimension: profile_adpnumber {
    sql: ${TABLE}.profile_adpnumber ;;
    type: string
}
