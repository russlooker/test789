...
view: 1SVZQ0HBH2_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1SVZQ0HBH2] ;;
...
dimension: profile_orglvl1 {
    sql: ${TABLE}.profile_orglvl1 ;;
    type: string
}


    
dimension: profile_orglvl2 {
    sql: ${TABLE}.profile_orglvl2 ;;
    type: string
}


    
dimension: profile_orglvl3 {
    sql: ${TABLE}.profile_orglvl3 ;;
    type: string
}
...
dimension: profile_orglvl4 {
    sql: ${TABLE}.profile_orglvl4 ;;
    type: string
}


    
dimension: profile_orglvl5 {
    sql: ${TABLE}.profile_orglvl5 ;;
    type: string
}


    
dimension: profile_orglvl6 {
    sql: ${TABLE}.profile_orglvl6 ;;
    type: string
}


    
dimension: profile_hcregion {
    sql: ${TABLE}.profile_hcregion ;;
    type: string
}
