...
view: 1QPJSRHAUY_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1QPJSRHAUY] ;;
...
dimension: profile_adpno {
    sql: ${TABLE}.profile_adpno ;;
    type: string
}


    
dimension: profile_paygroupcode {
    sql: ${TABLE}.profile_paygroupcode ;;
    type: string
}


    
dimension: profile_legalentity {
    sql: ${TABLE}.profile_legalentity ;;
    type: string
}
