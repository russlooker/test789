...
view: 1XHYEBDL5W_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1XHYEBDL5W] ;;
...
dimension: profile_home_department {
    sql: ${TABLE}.profile_home_department ;;
    type: string
}


    
dimension: profile_home_department_desc {
    sql: ${TABLE}.profile_home_department_desc ;;
    type: string
}
