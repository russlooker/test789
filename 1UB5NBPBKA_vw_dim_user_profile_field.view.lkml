...
view: 1UB5NBPBKA_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1UB5NBPBKA] ;;
...
dimension: profile_address_street {
    sql: ${TABLE}.profile_address_street ;;
    type: string
}


    
dimension: profile_address_city {
    sql: ${TABLE}.profile_address_city ;;
    type: string
}


    
dimension: profile_address_state {
    sql: ${TABLE}.profile_address_state ;;
    type: string
}
...
dimension: profile_address_zip_code {
    sql: ${TABLE}.profile_address_zip_code ;;
    type: string
}


    
dimension: profile_address_country {
    sql: ${TABLE}.profile_address_country ;;
    type: string
}
...
dimension: profile_site_country {
    sql: ${TABLE}.profile_site_country ;;
    type: string
}


    
dimension: profile_band_level {
    sql: ${TABLE}.profile_band_level ;;
    type: string
}


    
dimension: profile_virtual {
    sql: ${TABLE}.profile_virtual ;;
    type: string
}
