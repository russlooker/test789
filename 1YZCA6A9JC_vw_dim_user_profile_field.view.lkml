...
view: 1YZCA6A9JC_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1YZCA6A9JC] ;;
...
dimension: profile__business_title {
    sql: ${TABLE}.profile_BusinessTitle ;;
    type: string
}
