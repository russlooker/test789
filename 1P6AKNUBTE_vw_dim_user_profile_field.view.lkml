...
view: 1P6AKNUBTE_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1P6AKNUBTE] ;;
...
dimension: profile_employee_start_date {
    sql: ${TABLE}.profile_employee_start_date ;;
    type: string
}


    
dimension: profile_nh_id {
    sql: ${TABLE}.profile_nh_id ;;
    type: string
}
