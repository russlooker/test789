...
view: 1WMT00EHEL_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1WMT00EHEL] ;;
...
dimension: profile_lt2 {
    sql: ${TABLE}.profile_lt2 ;;
    type: string
}


    
dimension: profile_lt1 {
    sql: ${TABLE}.profile_lt1 ;;
    type: string
}
...
dimension: profile_lt {
    sql: ${TABLE}.profile_lt ;;
    type: string
}
