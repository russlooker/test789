...
view: 1YPD94DFBN_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1YPD94DFBN] ;;
...
dimension: profile_work_province {
    sql: ${TABLE}.profile_work_province ;;
    type: string
}
...
dimension: profile_street_work {
    sql: ${TABLE}.profile_street_work ;;
    type: string
}


    
dimension: profile_postalcode_work {
    sql: ${TABLE}.profile_postalcode_work ;;
    type: string
}
