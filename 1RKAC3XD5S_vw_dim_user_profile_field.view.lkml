...
view: 1RKAC3XD5S_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1RKAC3XD5S] ;;
...
dimension: profile_managername {
    sql: ${TABLE}.profile_managername ;;
    type: string
}


    
dimension: profile_directvpname {
    sql: ${TABLE}.profile_directvpname ;;
    type: string
}


    
dimension: profile_managementchain {
    sql: ${TABLE}.profile_managementchain ;;
    type: string
}
