...
view: 1QGZ499SY4_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1QGZ499SY4] ;;
...
dimension: profile_employeehiredate {
    sql: ${TABLE}.profile_employeehiredate ;;
    type: string
}


    
dimension: profile_employeedirectreportscount {
    sql: ${TABLE}.profile_employeedirectreportscount ;;
    type: string
}
