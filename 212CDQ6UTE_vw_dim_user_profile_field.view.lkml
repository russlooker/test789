...
view: 212CDQ6UTE_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_212CDQ6UTE] ;;
...
dimension: profile__network_id {
    sql: ${TABLE}.profile_Network_ID ;;
    type: string
}
