...
view: 5PN41RV3ZC_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_5PN41RV3ZC] ;;
...
dimension: profile_elt_name {
    sql: ${TABLE}.profile_elt_name ;;
    type: string
}
