...
view: 1ZJYDZXMAU_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1ZJYDZXMAU] ;;
...
dimension: profile_hr_manager_name {
    sql: ${TABLE}.profile_hr_manager_name ;;
    type: string
}


    
dimension: profile_hr_manager_email {
    sql: ${TABLE}.profile_hr_manager_email ;;
    type: string
}
