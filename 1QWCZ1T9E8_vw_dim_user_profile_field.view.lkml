...
view: 1QWCZ1T9E8_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1QWCZ1T9E8] ;;
...
dimension: profile_gl_rpt_loc {
    sql: ${TABLE}.profile_GL_RPT_LOC ;;
    type: string
}


    
dimension: profile__staff__level {
    sql: ${TABLE}.profile_Staff_Level ;;
    type: string
}
