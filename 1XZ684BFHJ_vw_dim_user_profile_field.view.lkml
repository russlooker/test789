...
view: 1XZ684BFHJ_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1XZ684BFHJ] ;;
...
dimension: profile_job_code_description {
    sql: ${TABLE}.profile_job_code_description ;;
    type: string
}
