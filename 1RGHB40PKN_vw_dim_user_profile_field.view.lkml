...
view: 1RGHB40PKN_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1RGHB40PKN] ;;
...
dimension: profile_budescr {
    sql: ${TABLE}.profile_budescr ;;
    type: string
}
...
dimension: profile_costctrcd {
    sql: ${TABLE}.profile_costctrcd ;;
    type: string
}


    
dimension: profile_costctrde {
    sql: ${TABLE}.profile_costctrde ;;
    type: string
}


    
dimension: profile_costctrlc {
    sql: ${TABLE}.profile_costctrlc ;;
    type: string
}


    
dimension: profile_dsunique {
    sql: ${TABLE}.profile_dsunique ;;
    type: string
}


    
dimension: profile_emplstatus {
    sql: ${TABLE}.profile_emplstatus ;;
    type: string
}
