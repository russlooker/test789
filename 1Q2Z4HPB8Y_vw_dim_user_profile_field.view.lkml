...
view: 1Q2Z4HPB8Y_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1Q2Z4HPB8Y] ;;
...
dimension: profile_payschedule {
    sql: ${TABLE}.profile_payschedule ;;
    type: string
}
