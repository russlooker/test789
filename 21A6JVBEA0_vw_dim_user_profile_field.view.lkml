...
view: 21A6JVBEA0_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_21A6JVBEA0] ;;
...
dimension: profile_unplugged_worker {
    sql: ${TABLE}.profile_unplugged_worker ;;
    type: string
}
