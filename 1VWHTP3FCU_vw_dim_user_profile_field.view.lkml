...
view: 1VWHTP3FCU_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1VWHTP3FCU] ;;
...
dimension: profile_department_id {
    sql: ${TABLE}.profile_department_id ;;
    type: string
}
