...
view: 20ZYAB0CHS_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_20ZYAB0CHS] ;;
...
dimension: profile_personnel_area_code {
    sql: ${TABLE}.profile_personnel_area_code ;;
    type: string
}
