...
view: 1QJUFZG89W_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1QJUFZG89W] ;;
...
dimension: profile_display_name {
...
dimension: profile_samaccountname {
    sql: ${TABLE}.profile_samaccountname ;;
    type: string
}
