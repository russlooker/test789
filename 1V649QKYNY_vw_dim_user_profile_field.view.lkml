...
view: 1V649QKYNY_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1V649QKYNY] ;;
...
dimension: profile_dietary_needs {
    sql: ${TABLE}.profile_dietary_needs ;;
    type: string
}
...
dimension: profile_special_requirements {
    sql: ${TABLE}.profile_special_requirements ;;
    type: string
}


    
dimension: profile_occupation {
    sql: ${TABLE}.profile_occupation ;;
    type: string
}
...
dimension: profile_business_number {
    sql: ${TABLE}.profile_business_number ;;
    type: string
}


    
dimension: profile_pay_status {
    sql: ${TABLE}.profile_pay_status ;;
    type: string
}
