...
view: 1Z1GWT8N3E_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1Z1GWT8N3E] ;;
...
dimension: profile_service_dt {
    sql: ${TABLE}.profile_service_dt ;;
    type: string
}
