...
view: 21KZ7MAFSU_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_21KZ7MAFSU] ;;
...
dimension: profile_profile_hire_date {
    sql: ${TABLE}.profile_profile_hire_date ;;
    type: string
}
...
dimension: profile_home_dept {
    sql: ${TABLE}.profile_home_dept ;;
    type: string
}
