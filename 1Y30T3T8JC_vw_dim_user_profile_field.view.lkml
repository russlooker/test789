...
view: 1Y30T3T8JC_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1Y30T3T8JC] ;;
...
dimension: profile_mailstop {
    sql: ${TABLE}.profile_mailstop ;;
    type: string
}
...
dimension: profile_manager_email {
    sql: ${TABLE}.profile_manager_email ;;
    type: string
}


    
dimension: profile_manager_firstname {
    sql: ${TABLE}.profile_manager_firstname ;;
    type: string
}


    
dimension: profile_manager_lastname {
    sql: ${TABLE}.profile_manager_lastname ;;
    type: string
}
...
dimension: profile_enterprise {
    sql: ${TABLE}.profile_enterprise ;;
    type: string
}
