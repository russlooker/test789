...
view: 1S259X631J_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1S259X631J] ;;
...
dimension: profile_deptcode {
    sql: ${TABLE}.profile_deptcode ;;
    type: string
}
