...
view: 1ZLV6DTHAG_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1ZLV6DTHAG] ;;
...
dimension: profile_locations {
    sql: ${TABLE}.profile_locations ;;
    type: string
}
