...
view: 1ZZ5ZFD3BE_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1ZZ5ZFD3BE] ;;
...
dimension: profile_office_location {
    sql: ${TABLE}.profile_office_location ;;
    type: string
}
