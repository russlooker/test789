...
view: 1TU6U8DK48_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1TU6U8DK48] ;;
...
dimension: profile_seedingdate {
    sql: ${TABLE}.profile_seedingdate ;;
    type: string
}
