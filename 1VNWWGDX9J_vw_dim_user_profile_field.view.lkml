...
view: 1VNWWGDX9J_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1VNWWGDX9J] ;;
...
dimension: profile_hierarchical_level {
    sql: ${TABLE}.profile_hierarchical_level ;;
    type: string
}


    
dimension: profile_global_head {
    sql: ${TABLE}.profile_global_head ;;
    type: string
}
