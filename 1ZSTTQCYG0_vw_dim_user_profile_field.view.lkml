...
view: 1ZSTTQCYG0_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1ZSTTQCYG0] ;;
...
dimension: profile_termination {
    sql: ${TABLE}.profile_termination ;;
    type: string
}
