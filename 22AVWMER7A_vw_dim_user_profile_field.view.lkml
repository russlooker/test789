...
view: 22AVWMER7A_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_22AVWMER7A] ;;
...
dimension: profile_org_level {
    sql: ${TABLE}.profile_org_level ;;
    type: string
}
