...
view: 1R2B0V1EA4_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1R2B0V1EA4] ;;
...
dimension: profile_building {
    sql: ${TABLE}.profile_building ;;
    type: string
}
