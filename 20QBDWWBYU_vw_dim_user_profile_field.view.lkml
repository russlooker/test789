...
view: 20QBDWWBYU_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_20QBDWWBYU] ;;
...
dimension: profile_lengthofservice {
    sql: ${TABLE}.profile_lengthofservice ;;
    type: string
}
