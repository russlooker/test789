...
view: 1PZ1JVESE0_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1PZ1JVESE0] ;;
...
dimension: profile_empl_type {
    sql: ${TABLE}.profile_empl_type ;;
    type: string
}


    
dimension: profile_attached_file_id {
    sql: ${TABLE}.profile_attached_file_id ;;
    type: string
}
...
dimension: profile_file_no {
    sql: ${TABLE}.profile_file_no ;;
    type: string
}
...
dimension: profile_co_code {
    sql: ${TABLE}.profile_co_code ;;
    type: string
}
