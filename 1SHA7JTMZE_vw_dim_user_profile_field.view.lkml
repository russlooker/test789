...
view: 1SHA7JTMZE_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1SHA7JTMZE] ;;
...
dimension: profile_employment_type {
    sql: ${TABLE}.profile_employment_type ;;
    type: string
}
...
dimension: profile_comp_frequency {
    sql: ${TABLE}.profile_compFrequency ;;
    type: string
}
...
dimension: profile__additional_exclusionfrom_staff_survey {
    sql: ${TABLE}.profile_AdditionalExclusionfromStaffSurvey ;;
    type: string
}
