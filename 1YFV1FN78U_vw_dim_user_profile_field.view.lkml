...
view: 1YFV1FN78U_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1YFV1FN78U] ;;
...
dimension: profile_reports_to_person {
    sql: ${TABLE}.profile_reports_to_person ;;
    type: string
}
...
dimension: profile_home_cost_center_number {
    sql: ${TABLE}.profile_home_cost_center_number ;;
    type: string
}
...
dimension: profile_ad_account_name {
    sql: ${TABLE}.profile_ad_account_name ;;
    type: string
}
