...
view: 1YM55NPZ0C_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1YM55NPZ0C] ;;
...
dimension: profile__cost__center__description {
    sql: ${TABLE}.profile_Cost_Center_Description ;;
    type: string
}
...
dimension: profile_legacy {
    sql: ${TABLE}.profile_legacy ;;
    type: string
}
