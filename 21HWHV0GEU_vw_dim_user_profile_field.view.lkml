...
view: 21HWHV0GEU_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_21HWHV0GEU] ;;
...
dimension: profile__job_level_descr {
    sql: ${TABLE}.profile_JobLevelDescr ;;
    type: string
}


    
dimension: profile__sub_p_descr {
    sql: ${TABLE}.profile_SubPDescr ;;
    type: string
}


    
dimension: profile__employee_class {
    sql: ${TABLE}.profile_EmployeeClass ;;
    type: string
}
