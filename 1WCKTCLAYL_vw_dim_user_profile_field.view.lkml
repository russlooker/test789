...
view: 1WCKTCLAYL_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1WCKTCLAYL] ;;
...
dimension: profile_birth_year {
    sql: ${TABLE}.profile_birth_year ;;
    type: string
}
