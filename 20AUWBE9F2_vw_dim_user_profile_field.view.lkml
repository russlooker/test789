...
view: 20AUWBE9F2_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_20AUWBE9F2] ;;
...
dimension: profile_director {
    sql: ${TABLE}.profile_director ;;
    type: string
}
