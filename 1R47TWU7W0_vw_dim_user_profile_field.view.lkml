...
view: 1R47TWU7W0_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1R47TWU7W0] ;;
...
dimension: profile_legal_employing_entity {
    sql: ${TABLE}.profile_legal_employing_entity ;;
    type: string
}
