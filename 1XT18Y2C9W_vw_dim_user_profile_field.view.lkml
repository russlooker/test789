...
view: 1XT18Y2C9W_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1XT18Y2C9W] ;;
...
dimension: profile_adjusted_hire_date {
    sql: ${TABLE}.profile_ADJUSTED_HIRE_DATE ;;
    type: string
}
