...
view: 1R81NHTY3W_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1R81NHTY3W] ;;
...
dimension: profile_pay_scale_group {
    sql: ${TABLE}.profile_pay_scale_group ;;
    type: string
}
...
dimension: profile_cost_center_text {
    sql: ${TABLE}.profile_cost_center_text ;;
    type: string
}


    
dimension: profile_work_location {
    sql: ${TABLE}.profile_work_location ;;
    type: string
}


    
dimension: profile_work_location_text {
    sql: ${TABLE}.profile_work_location_text ;;
    type: string
}


    
dimension: profile_no_of_pay_periods {
    sql: ${TABLE}.profile_no_of_pay_periods ;;
    type: string
}
...
dimension: profile_functional_org {
    sql: ${TABLE}.profile_functional_org ;;
    type: string
}
