...
view: 1Z8VUW053N_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1Z8VUW053N] ;;
...
dimension: profile_businessunit {
...
dimension: profile_costcenter {
    sql: ${TABLE}.profile_costcenter ;;
    type: string
}
...
dimension: profile_financialco {
    sql: ${TABLE}.profile_financialco ;;
    type: string
}


    
dimension: profile_searchcountry {
    sql: ${TABLE}.profile_searchcountry ;;
    type: string
}


    
dimension: profile_octeib {
    sql: ${TABLE}.profile_octeib ;;
    type: string
}
