...
view: 1RVX9T1T1W_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1RVX9T1T1W] ;;
...
dimension: profile_payrollprovider {
    sql: ${TABLE}.profile_payrollprovider ;;
    type: string
}
