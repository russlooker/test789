...
view: 1WYUJMGP7S_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1WYUJMGP7S] ;;
...
dimension: profile_center {
    sql: ${TABLE}.profile_center ;;
    type: string
}


    
dimension: profile_mission_center {
    sql: ${TABLE}.profile_mission_center ;;
    type: string
}


    
dimension: profile_super_division {
    sql: ${TABLE}.profile_super_division ;;
    type: string
}
