...
view: 1ZX6QQ3WE4_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1ZX6QQ3WE4] ;;
...
dimension: profile_employee_working_location {
    sql: ${TABLE}.profile_employee_working_location ;;
    type: string
}


    
dimension: profile__leader_vp_or_above {
    sql: ${TABLE}.profile_Leader_VP_or_above ;;
    type: string
}


    
dimension: profile_business_unit_assigned_dept {
    sql: ${TABLE}.profile_business_unit_assigned_dept ;;
    type: string
}
...
dimension: profile_manager_supervisor {
    sql: ${TABLE}.profile_manager_supervisor ;;
    type: string
}
