...
view: 1U43SBKUXA_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1U43SBKUXA] ;;
...
dimension: profile_prid {
    sql: ${TABLE}.profile_prid ;;
    type: string
}
...
dimension: profile_nt_domain {
    sql: ${TABLE}.profile_nt_domain ;;
    type: string
}


    
dimension: profile_organization {
    sql: ${TABLE}.profile_organization ;;
    type: string
}


    
dimension: profile_organization_id {
    sql: ${TABLE}.profile_organization_id ;;
    type: string
}
...
dimension: profile_cost_center_id {
    sql: ${TABLE}.profile_cost_center_id ;;
    type: string
}
...
dimension: profile_function_id {
    sql: ${TABLE}.profile_function_id ;;
    type: string
}
...
dimension: profile_territory_id {
    sql: ${TABLE}.profile_territory_id ;;
    type: string
}
...
dimension: profile_job_profile {
    sql: ${TABLE}.profile_job_profile ;;
    type: string
}
...
dimension: profile_business_site {
    sql: ${TABLE}.profile_business_site ;;
    type: string
}
