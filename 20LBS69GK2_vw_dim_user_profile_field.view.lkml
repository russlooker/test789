...
view: 20LBS69GK2_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_20LBS69GK2] ;;
...
dimension: profile_sub_function {
    sql: ${TABLE}.profile_sub_function ;;
    type: string
}
