...
view: 1V0834YYS8_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1V0834YYS8] ;;
...
dimension: profile_standard_weeklyhours_jobinformation {
    sql: ${TABLE}.profile_standard_weeklyhours_jobinformation ;;
    type: string
}
