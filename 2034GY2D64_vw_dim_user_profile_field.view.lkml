...
view: 2034GY2D64_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_2034GY2D64] ;;
...
dimension: profile_identity_profile_id {
    sql: ${TABLE}.profile_identity_profile_id ;;
    type: string
}
...
dimension: profile_level_4_name {
    sql: ${TABLE}.profile_level_4_name ;;
    type: string
}
