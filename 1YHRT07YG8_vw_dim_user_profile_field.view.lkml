...
view: 1YHRT07YG8_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1YHRT07YG8] ;;
...
dimension: profile_job_position {
    sql: ${TABLE}.profile_job_position ;;
    type: string
}


    
dimension: profile_job_classification {
    sql: ${TABLE}.profile_job_classification ;;
    type: string
}
...
dimension: profile_practice_area {
    sql: ${TABLE}.profile_practice_area ;;
    type: string
}
