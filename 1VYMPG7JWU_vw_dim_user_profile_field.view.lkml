...
view: 1VYMPG7JWU_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1VYMPG7JWU] ;;
...
dimension: profile_payroll_group {
    sql: ${TABLE}.profile_payroll_group ;;
    type: string
}
