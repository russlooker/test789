...
view: 1YD3EW5PW4_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1YD3EW5PW4] ;;
...
dimension: profile_hourly_bill_rate {
    sql: ${TABLE}.profile_hourly_bill_rate ;;
    type: string
}
...
dimension: profile_home_country {
    sql: ${TABLE}.profile_home_country ;;
    type: string
}
