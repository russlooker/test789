...
view: 20NDEPJMY0_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_20NDEPJMY0] ;;
...
dimension: profile_zcntloginpimary {
    sql: ${TABLE}.profile_zcntloginpimary ;;
    type: string
}


    
dimension: profile_bellcompanycode {
    sql: ${TABLE}.profile_bellcompanycode ;;
    type: string
}


    
dimension: profile_oen {
    sql: ${TABLE}.profile_oen ;;
    type: string
}
...
dimension: profile_bellbunameen {
    sql: ${TABLE}.profile_bellbunameen ;;
    type: string
}


    
dimension: profile_cp5 {
    sql: ${TABLE}.profile_CP5 ;;
    type: string
}


    
dimension: profile_cp6 {
    sql: ${TABLE}.profile_CP6 ;;
    type: string
}


    
dimension: profile_cp7 {
    sql: ${TABLE}.profile_CP7 ;;
    type: string
}


    
dimension: profile_bellcplevelen {
    sql: ${TABLE}.profile_bellcplevelen ;;
    type: string
}


    
dimension: profile_roomnumber {
    sql: ${TABLE}.profile_roomnumber ;;
    type: string
}
...
dimension: profile_st {
    sql: ${TABLE}.profile_st ;;
    type: string
}


    
dimension: profile_postalcode {
    sql: ${TABLE}.profile_postalcode ;;
    type: string
}
