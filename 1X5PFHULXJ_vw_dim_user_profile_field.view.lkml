...
view: 1X5PFHULXJ_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1X5PFHULXJ] ;;
...
dimension: profile_pyschedule {
    sql: ${TABLE}.profile_pyschedule ;;
    type: string
}


    
dimension: profile_sappernr {
    sql: ${TABLE}.profile_sappernr ;;
    type: string
}


    
dimension: profile_localpyid {
    sql: ${TABLE}.profile_localpyid ;;
    type: string
}
...
dimension: profile_dob {
    sql: ${TABLE}.profile_dob ;;
    type: string
}
