...
view: 1P4CAQKF48_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1P4CAQKF48] ;;
...
dimension: profile__workday__account {
    sql: ${TABLE}.profile_Workday_Account ;;
    type: string
}
...
dimension: profile__business__title {
