...
view: 1VTBNC2FS0_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1VTBNC2FS0] ;;
...
dimension: profile_vpg__status {
    sql: ${TABLE}.profile_VPG_Status ;;
    type: string
}


    
dimension: profile__associate__phone__number {
    sql: ${TABLE}.profile_Associate_Phone_Number ;;
    type: string
}
...
dimension: profile__cost__center__name {
...
dimension: profile__tenure {
    sql: ${TABLE}.profile_Tenure ;;
    type: string
}
...
dimension: profile__cost__center_id {
...
dimension: profile_office_location_region {
    sql: ${TABLE}.profile_office_location_region ;;
    type: string
}
