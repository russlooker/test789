...
view: 1VFGM59X2G_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1VFGM59X2G] ;;
...
dimension: profile_team {
    sql: ${TABLE}.profile_team ;;
    type: string
}


    
dimension: profile_team_1_group {
    sql: ${TABLE}.profile_team_1_group ;;
    type: string
}
...
dimension: profile_team_2 {
    sql: ${TABLE}.profile_team_2 ;;
    type: string
}
