...
view: 1Y53EVNADW_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1Y53EVNADW] ;;
...
dimension: profile_employee_org {
    sql: ${TABLE}.profile_employee_org ;;
    type: string
}
...
dimension: profile_manager_level {
    sql: ${TABLE}.profile_manager_level ;;
    type: string
}
...
dimension: profile_new_hire_date {
    sql: ${TABLE}.profile_new_hire_date ;;
    type: string
}
