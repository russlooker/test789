...
view: 1RMCX9QJG8_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1RMCX9QJG8] ;;
...
dimension: profile_telephone {
    sql: ${TABLE}.profile_telephone ;;
    type: string
}
