...
view: 1PMN96TBLL_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1PMN96TBLL] ;;
...
dimension: profile_last-date-worked {
    sql: ${TABLE}.profile_last-date-worked ;;
    type: string
}


    
dimension: profile_hire-date {
    sql: ${TABLE}.profile_hire-date ;;
    type: string
}
