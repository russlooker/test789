...
view: 21YPGGF30G_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_21YPGGF30G] ;;
...
dimension: profile_jobfunction {
    sql: ${TABLE}.profile_jobfunction ;;
    type: string
}
...
dimension: profile_costgroup {
    sql: ${TABLE}.profile_costgroup ;;
    type: string
}


    
dimension: profile_officelocation {
...
dimension: profile_employeetier {
    sql: ${TABLE}.profile_employeetier ;;
    type: string
}
...
dimension: profile_paycode {
    sql: ${TABLE}.profile_paycode ;;
    type: string
}
