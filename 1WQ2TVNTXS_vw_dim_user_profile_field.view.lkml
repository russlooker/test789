...
view: 1WQ2TVNTXS_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1WQ2TVNTXS] ;;
...
dimension: profile__mgmt__level_02 {
    sql: ${TABLE}.Profile_Mgmt_Level_02 ;;
    type: string
}


    
dimension: profile__mgmt__level {
    sql: ${TABLE}.Profile_Mgmt_Level ;;
    type: string
}


    
dimension: profile__business__unit {
...
dimension: profile_wfh {
    sql: ${TABLE}.Profile_WFH ;;
    type: string
}


    
dimension: profile__job__title {
...
dimension: profile__manager__name {
