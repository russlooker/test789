...
view: 1WH3XN3SRA_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1WH3XN3SRA] ;;
...
dimension: profile_language {
    sql: ${TABLE}.profile_language ;;
    type: string
}
