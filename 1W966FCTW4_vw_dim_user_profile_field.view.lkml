...
view: 1W966FCTW4_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1W966FCTW4] ;;
...
dimension: profile_age_category {
    sql: ${TABLE}.profile_age_category ;;
    type: string
}
...
dimension: profile_tenure_category {
    sql: ${TABLE}.profile_tenure_category ;;
    type: string
}


    
dimension: profile_employment_category {
    sql: ${TABLE}.profile_employment_category ;;
    type: string
}
