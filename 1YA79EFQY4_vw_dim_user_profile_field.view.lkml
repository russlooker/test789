...
view: 1YA79EFQY4_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1YA79EFQY4] ;;
...
dimension: profile_t1 {
    sql: ${TABLE}.profile_t1 ;;
    type: string
}


    
dimension: profile_t2 {
    sql: ${TABLE}.profile_t2 ;;
    type: string
}


    
dimension: profile_t3 {
    sql: ${TABLE}.profile_t3 ;;
    type: string
}
...
dimension: profile_t4 {
    sql: ${TABLE}.profile_t4 ;;
    type: string
}
