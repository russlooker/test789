...
view: 1SNAMQAP6G_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1SNAMQAP6G] ;;
...
dimension: profile_region {
    sql: ${TABLE}.profile_region ;;
    type: string
}


    
dimension: profile_work_building {
    sql: ${TABLE}.profile_work_building ;;
    type: string
}


    
dimension: profile_work_street {
    sql: ${TABLE}.profile_work_street ;;
    type: string
}
...
dimension: profile_work_zip_code {
    sql: ${TABLE}.profile_work_zip_code ;;
    type: string
}


    
dimension: profile_work_country {
    sql: ${TABLE}.profile_work_country ;;
    type: string
}


    
dimension: profile_home_state {
    sql: ${TABLE}.profile_home_state ;;
    type: string
}
