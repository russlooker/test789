...
view: 1ZCY2PDBS4_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1ZCY2PDBS4] ;;
...
dimension: profile_level_3_company {
    sql: ${TABLE}.profile_level_3_company ;;
    type: string
}
...
dimension: profile_work_zip {
    sql: ${TABLE}.profile_work_zip ;;
    type: string
}
