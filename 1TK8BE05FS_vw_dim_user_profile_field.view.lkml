...
view: 1TK8BE05FS_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1TK8BE05FS] ;;
...
dimension: profile_lob_platform_code {
    sql: ${TABLE}.profile_lob_platform_code ;;
    type: string
}


    
dimension: profile_bufugu {
    sql: ${TABLE}.profile_bufugu ;;
    type: string
}
...
dimension: profile_transit {
    sql: ${TABLE}.profile_transit ;;
    type: string
}


    
dimension: profile_lob_platform_desc {
    sql: ${TABLE}.profile_lob_platform_desc ;;
    type: string
}
...
dimension: profile_age_range {
    sql: ${TABLE}.profile_age_range ;;
    type: string
}
