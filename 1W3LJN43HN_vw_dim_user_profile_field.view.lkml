...
view: 1W3LJN43HN_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1W3LJN43HN] ;;
...
dimension: profile_psid {
    sql: ${TABLE}.profile_psid ;;
    type: string
}


    
dimension: profile_batch_name {
    sql: ${TABLE}.profile_batch_name ;;
    type: string
}
