...
view: 1W4CJJGMDW_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1W4CJJGMDW] ;;
...
dimension: profile_business_segment {
    sql: ${TABLE}.profile_business_segment ;;
    type: string
}
...
dimension: profile_department_name {
    sql: ${TABLE}.profile_department_name ;;
    type: string
}
...
dimension: profile_gl_function {
    sql: ${TABLE}.profile_gl_function ;;
    type: string
}
...
dimension: profile_grade_group {
    sql: ${TABLE}.profile_grade_group ;;
    type: string
}
