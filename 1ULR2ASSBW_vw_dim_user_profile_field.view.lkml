...
view: 1ULR2ASSBW_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1ULR2ASSBW] ;;
...
dimension: profile_end_date {
    sql: ${TABLE}.profile_end_date ;;
    type: string
}
...
dimension: profile_supervisor_level1 {
    sql: ${TABLE}.profile_supervisor_level1 ;;
    type: string
}


    
dimension: profile_supervisor_level2 {
    sql: ${TABLE}.profile_supervisor_level2 ;;
    type: string
}


    
dimension: profile_supervisor_level3 {
    sql: ${TABLE}.profile_supervisor_level3 ;;
    type: string
}


    
dimension: profile_supervisor_level4 {
    sql: ${TABLE}.profile_supervisor_level4 ;;
    type: string
}
...
dimension: profile_functional_area {
    sql: ${TABLE}.profile_functional_area ;;
    type: string
}


    
dimension: profile_business_unit_descr {
    sql: ${TABLE}.profile_business_unit_descr ;;
    type: string
}
