...
view: 1NLAE7X5SC_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1NLAE7X5SC] ;;
...
dimension: profile_advisor_id {
    sql: ${TABLE}.profile_advisor_id ;;
    type: string
}
...
dimension: profile_badgeid {
    sql: ${TABLE}.profile_badgeid ;;
    type: string
}
