...
view: 20T71472RJ_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_20T71472RJ] ;;
...
dimension: profile__manager_display_name {
    sql: ${TABLE}.profile_ManagerDisplayName ;;
    type: string
}
