...
view: 1VW6Y5VF40_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1VW6Y5VF40] ;;
...
dimension: profile_unit {
    sql: ${TABLE}.profile_unit ;;
    type: string
}
...
dimension: profile_emp_typ {
    sql: ${TABLE}.profile_emp_typ ;;
    type: string
}
