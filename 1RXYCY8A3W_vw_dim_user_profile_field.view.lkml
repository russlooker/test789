...
view: 1RXYCY8A3W_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1RXYCY8A3W] ;;
...
dimension: profile_hireyear {
    sql: ${TABLE}.profile_hireyear ;;
    type: string
}


    
dimension: profile_jobclassification {
    sql: ${TABLE}.profile_jobclassification ;;
    type: string
}
