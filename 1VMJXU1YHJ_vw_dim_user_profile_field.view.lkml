...
view: 1VMJXU1YHJ_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1VMJXU1YHJ] ;;
...
dimension: profile_adp_id {
    sql: ${TABLE}.profile_adp_id ;;
    type: string
}
...
dimension: profile_reg_region {
    sql: ${TABLE}.profile_reg_region ;;
    type: string
}
...
dimension: profile_reg_region_description {
    sql: ${TABLE}.profile_reg_region_description ;;
    type: string
}
...
dimension: profile_location_code {
    sql: ${TABLE}.profile_location_code ;;
    type: string
}
...
dimension: profile_hr_status {
    sql: ${TABLE}.profile_hr_status ;;
    type: string
}
