...
view: 1X8EUTYX5A_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1X8EUTYX5A] ;;
...
dimension: profile__middle_name {
...
dimension: profile__org_unit_id {
...
dimension: profile__preferred_lang {
    sql: ${TABLE}.profile_PreferredLang ;;
    type: string
}
...
dimension: profile__work_building_no {
    sql: ${TABLE}.profile_WorkBuildingNo ;;
    type: string
}


    
dimension: profile__work_house {
    sql: ${TABLE}.profile_WorkHouse ;;
    type: string
}


    
dimension: profile__work_contr {
    sql: ${TABLE}.profile_WorkContr ;;
    type: string
}


    
dimension: profile__start_date {
    sql: ${TABLE}.profile_StartDate ;;
    type: string
}
