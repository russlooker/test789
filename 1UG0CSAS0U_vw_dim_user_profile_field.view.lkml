...
view: 1UG0CSAS0U_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1UG0CSAS0U] ;;
...
dimension: profile_personnelareapostalcode {
    sql: ${TABLE}.profile_personnelareapostalcode ;;
    type: string
}
