...
view: 21WMJEYT7A_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_21WMJEYT7A] ;;
...
dimension: profile_costing_string {
    sql: ${TABLE}.profile_costing_string ;;
    type: string
}
...
dimension: profile_hr_org {
    sql: ${TABLE}.profile_hr_org ;;
    type: string
}


    
dimension: profile_supname {
    sql: ${TABLE}.profile_supname ;;
    type: string
}


    
dimension: profile_supempno {
    sql: ${TABLE}.profile_supempno ;;
    type: string
}


    
dimension: profile_fullname {
    sql: ${TABLE}.profile_fullname ;;
    type: string
}
