...
view: 1Q8VLCTHG4_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1Q8VLCTHG4] ;;
...
dimension: profile_vendor_id {
    sql: ${TABLE}.profile_vendor_id ;;
    type: string
}
