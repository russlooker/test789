...
view: 1PURUUDWEC_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1PURUUDWEC] ;;
...
dimension: profile_state_name {
    sql: ${TABLE}.profile_state_name ;;
    type: string
}
