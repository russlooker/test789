...
view: 1VBSYD4J2U_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1VBSYD4J2U] ;;
...
dimension: profile_six_months {
    sql: ${TABLE}.profile_six_months ;;
    type: string
}
