...
view: 1WDJZ7V51S_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1WDJZ7V51S] ;;
...
dimension: profile_pl_code {
    sql: ${TABLE}.profile_pl_code ;;
    type: string
}
...
dimension: profile_management_team {
    sql: ${TABLE}.profile_management_team ;;
    type: string
}
