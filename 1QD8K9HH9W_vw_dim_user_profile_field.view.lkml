...
view: 1QD8K9HH9W_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1QD8K9HH9W] ;;
...
dimension: profile_full_part_time {
    sql: ${TABLE}.profile_full_part_time ;;
    type: string
}


    
dimension: profile_regular_temporary {
    sql: ${TABLE}.profile_regular_temporary ;;
    type: string
}
...
dimension: profile_mail_stop {
    sql: ${TABLE}.profile_mail_stop ;;
    type: string
}
