...
view: 1WJSLVU2LQ_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1WJSLVU2LQ] ;;
...
dimension: profile_cog_office {
    sql: ${TABLE}.profile_cog_office ;;
    type: string
}


    
dimension: profile_location_office {
    sql: ${TABLE}.profile_location_office ;;
    type: string
}
...
dimension: profile_person_title {
    sql: ${TABLE}.profile_person_title ;;
    type: string
}


    
dimension: profile_skill {
    sql: ${TABLE}.profile_skill ;;
    type: string
}
