...
view: 1PJB1NXRFE_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_1PJB1NXRFE] ;;
...
dimension: profile_compid {
    sql: ${TABLE}.profile_COMPID ;;
    type: string
}
