...
view: 21Q9ZTY6WY_vw_dim_user_profile_field {
sql_table_name: [lookertest].[RPT].[vwDimUserProfileField_21Q9ZTY6WY] ;;
...
dimension: profile_unionmgmtstatus {
    sql: ${TABLE}.profile_unionmgmtstatus ;;
    type: string
}


    
dimension: profile_grandbandcod {
    sql: ${TABLE}.profile_grandbandcod ;;
    type: string
}
